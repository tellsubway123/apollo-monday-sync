...
LOUIS_USER_ID = "6a171a990217cf001039ff2a"
...
all_campaigns = campaign_response.json().get("emailer_campaigns", [])

campaigns = [
    campaign
    for campaign in all_campaigns
    if campaign.get("user_id") == LOUIS_USER_ID
]

print("LOUIS CAMPAIGNS FOUND:", len(campaigns))
